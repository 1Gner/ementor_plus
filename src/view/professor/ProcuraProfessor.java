...
public class ProcuraProfessor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					ProcuraProfessor frame = new ProcuraProfessor();
	...
	public ProcuraProfessor() {
		...
		JLabel lblNewLabel = new JLabel("CPF Professor");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Sql sq = new Sql();
					if(sq.buscaProfessor(Long.parseLong(textField.getText())) != null) {
						JOptionPane.showMessageDialog(null, "Professor encontrado ");
						AlterarProfessor aa = new AlterarProfessor(sq.buscaProfessor(Long.parseLong(textField.getText())));
						aa.setVisible(true);
