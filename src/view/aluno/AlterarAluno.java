...
public class AlterarAluno extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					AlterarAluno frame = new AlterarAluno(aluno);
	...
	public AlterarAluno(Aluno aluno) {
		...
		JLabel lblNewLabel_7 = new JLabel("Matricula");
		lblNewLabel_7.setBounds(10, 258, 46, 14);
		contentPane.add(lblNewLabel_7);

		JLabel lblNewLabel_8 = new JLabel("Periodo");
		...
		lblNewLabel_10.setBounds(10, 308, 46, 14);
		...
		textField_1_data.setText(aluno.getDataNascimento());
		...
		textField_2_cpf.setText(aluno.getCPF().toString());
		...
		textField_3_telefone.setText(aluno.getTelefone());
		...
		textField_4_rua.setText(aluno.getRua());
		...
		textField_5_bairro.setText(aluno.getBairro());
		...
		textField_6_cidade.setText(aluno.getCidade());
		...
		textField_7_estado.setText(aluno.getEstado());
		...
		textField_8_matricula.setText(aluno.getMatricula().toString());
		textField_8_matricula.setBounds(119, 255, 284, 20);
		contentPane.add(textField_8_matricula);
		textField_8_matricula.setColumns(10);

		textField_9_periodo = new JTextField();
		textField_9_periodo.setText(aluno.getPeriodo());
		textField_9_periodo.setBounds(119, 280, 284, 20);
		contentPane.add(textField_9_periodo);
		textField_9_periodo.setColumns(10);

		textField_10_turma = new JTextField();
		textField_10_turma.setText(aluno.getTurma());
		textField_10_turma.setBounds(119, 305, 284, 20);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					pb.setVisible(true);
					sq.atualizaAluno(textField_nome.getText(), textField_1_data.getText(), Long.parseLong(textField_2_cpf.getText())
							...
							, Long.parseLong(textField_8_matricula.getText()), textField_9_periodo.getText(), textField_10_turma.getText(),aluno.getMatricula());
				}catch(Throwable t) {
		...
		btnNewButton_2.setBounds(22, 377, 89, 23);
